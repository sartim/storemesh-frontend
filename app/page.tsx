...
function productImage(product: Product) {
  // Deterministic remote placeholders keep the native local demo lightweight;
  // replace with the media service URL when product media is introduced.
  return `https://picsum.photos/seed/storemesh-${encodeURIComponent(product.sku ?? product.id)}/800/800`;
}
